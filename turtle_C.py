# ---
# ( patch 2022-06-24 implementing rotated text - more at script end )
# ---
...
ver  = "turtle 1.1b- - for Python 3.9 - 23.6.2022 (with rotated text)"
# print(_ver)

import tkinter
if not ( tkinter.TkVersion >= 8.6 and tkinter.TclVersion >= 8.6 ): 
    print("Warning turtle.py patched 'txt_angle' not supported ...")
    print("       ... in tkinter/tcl versions < 8.6")
...
class ScrolledCanvas(tkinter.Frame):
    ...
    def __init__(self, master, width=500, height=350,
        ...
        # !self._w = '.'
        # !self.master = master        
        # !super().__init__(self, master, width=width, height=height, bd=0, highlightthickness=0)
        # tkinter.Frame.__init__(self, master, width=width, height=height)
        """
        tkinter.Frame.__init__(self, master, width=width, height=height, bd=0, highlightthickness=0)
        ...
        self._canvas = tkinter.Canvas(master, width=width, height=height,
                                 bg=self.bg, relief=tkinter.SUNKEN, borderwidth=0, highlightthickness=0)
        self.hscroll = tkinter.Scrollbar(master, command=self._canvas.xview,
                                    orient=tkinter.HORIZONTAL)
        self.vscroll = tkinter.Scrollbar(master, command=self._canvas.yview)
...
__forwardmethods(ScrolledCanvas, tkinter.Canvas, '_canvas')
...
class TurtleScreenBase(object):
    ...
    def __init__(self, cv):
        ...
        else:  # expected: ordinary tkinter.Canvas
    ...
    def _blankimage(self):
        ...
        """
        img = tkinter.PhotoImage(width=1, height=1, master=self.cv)
        img.blank()
        return img
    ...
    def _image(self, filename):
        ...
        """
        return tkinter.PhotoImage(file=filename, master=self.cv)
    ...
    def _write(self, pos, txt, align, font, pencolor, txt_angle):
        ...
        item = self.cv.create_text(
            x-1, -y, text = txt, anchor = anchor[align],
    ...
    def __init__(self, cv, mode=_CFG["mode"],
        ...
        self._shapes = {
            ...
            "circle" : Shape("polygon", (
                ( 10.0,  0.00), (  9.51,  3.09), (  8.09,  5.88),
                ( 5.88,  8.09), (  3.09,  9.51), (  0.00, 10.00), 
                (-3.09,  9.51), ( -5.88,  8.09), ( -8.09,  5.88), 
                (-9.51,  3.09), (-10.00,  0.00), ( -9.51, -3.09), 
...
##############################  stamp stuff  ###############################
    ...
    def _write(self, txt, align, font, txt_angle):
    ...
    def write(self, arg, move=False, align="left", font=("Arial", 12, "normal"), txt_angle=None ):
...
if __name__ == "__main__":
    ...
    def demo2():
        ...
        tri.write("CAUGHT! ", font=("Arial", 16, "bold"), align="right", txt_angle=225)
        tri.pencolor("black")
        tri.pencolor("red")
...
mlnStr_implementationOf_rotatedText = '''  
                                     Claudio at stackoverflow 2022-06-24
    turtle.py version implementing rotated text by providing one more
    parameter 'txt_angle=' as follows (works for tkinter/tcl versions
    beginning from 8.6 an Python beginning with Python 3.7.2). Only the
    changed lines are listed first, than follow a class with which it 
    is possible to patch turtle,
----
( class TurtleScreenBase ):
    def _write(self, pos, txt, align, font, pencolor, txt_angle):

( class TurtleScreenBase, def _write ):
        item = self.cv.create_text(
            x-1, -y, text = txt, anchor = anchor[align],
            fill = pencolor, font = font, angle = txt_angle)
----
